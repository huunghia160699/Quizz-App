...
  //   shuffleOptions: false // Cờ xáo trộn (nếu có từ Python, mặc định False) - Hiện tại code JS sẽ tự động trộn
  // }
  allQuestion: null,
...
            // Dòng trên đã thực hiện xáo trộn và slice, dòng dưới này không cần thiết
            // this.allQuestion = this.allQuestion.slice(0, this.maxQuestion); // Remove this duplicate slice
...
  // --- Sửa đổi hàm loadQuestion để trộn lựa chọn ---
  loadQuestion() {
...
      // Lấy các chữ cái lựa chọn (A, B, C, ...)
      let optionLetters = Object.keys(currentQuestion.options);

      // --- Thêm chức năng trộn lựa chọn ở đây ---
      // Sử dụng hàm shuffleArray để trộn thứ tự các chữ cái lựa chọn
      optionLetters = this.shuffleArray(optionLetters);
      // -------------------------------------------
...
          // Hiển thị chữ cái lựa chọn ban đầu và nội dung
